# Code borrowed/inspired by: https://github.com/chrisckwong821/Curve_Finance_Slippage_Simulator/blob/main/simulation.py
...
class StableSwap:
    ...
    # find swapped amount without accounting fee
    def dy(self, i, j, dx):
        # dx and dy are in underlying units
        xp = self.xp()
        return xp[j] - self.y(i, j, xp[i] + dx)

    # find swapped amount with accounting fee
